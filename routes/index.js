...
const stripe = require('stripe')('sk_test_51GyDb8BNgNMzNNfDOfDDLjD8RPOkQBt5OnuTYsiNqZOZfaWR4k6WsrGk7mVSv9qn8r6oTcE54FWodbCObzqGi4fk00ioHt4aJd');

// gestion des sliders affichés sur la home

var meaSliders = [
  {url:"/images/slider1.jpg", alt:"slider1", landing:"/shop"},
  {url:"/images/slider2.jpg", alt:"slider2", landing:"/shop"},
  {url:"/images/slider3.jpg", alt:"slider3", landing:"/shop"}
]

// gestion des codes promos actifs
...
var sendToStripe = async (dataCardBike,selectedModeLiv,promoCmd) => {
  ...
  if(stripeCard.length>0){
    var session = await stripe.checkout.sessions.create({
      ...
      success_url: 'http://192.168.43.204:3000/success?session_id={CHECKOUT_SESSION_ID}',
      cancel_url: 'http://192.168.43.204:3000/',
    });
...
var getModeLivraison = (dataCardBike) => {
  ...
  var montantFraisPortRetrait= nbProduits * 10


  var listeModeLivraison = [
    {id:'1', libelle:'Livraison Standard', montant:montantFraisPortStandard},
    {id:'2', libelle:'Livraison Express', montant:montantFraisPortExpress},
    {id:'3', libelle:'Retrait en Boutique', montant:montantFraisPortRetrait},
  ]
